...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r} \\
	\textbf{\href{http://www.slackwill.com/}{\large William M. Dignazio}} & \href{mailto:wdignazio@gmail.com}{wdignazio@gmail.com}\\ &
...
Rochester, NY 14623}}} & \\
	...
	{\footnotesize {{Phone: (724) 831-7693}}} & Available for Cooperative Study Summer 2014
	\end{tabular*}
\\
\vspace{0.1in}}
		...
		\item
			\ressubheading{Rochester Institute of Technology - New York}{\href{http://www.rit.edu}{rit.edu}}{\href{http://www.cs.rit.edu/}{Undergraduate Computer Science Student}}{Aug. 2011 - Present}
				...
				\begin{itemize}
					...
					\item{Core Courses: Computer Science[1-4], FOSS (Free \& Open Source Software), Computer Organization, Software Engineering}
				\end{itemize}
				}
...
{ \footnotesize
	\begin{description}
		\item{\textbf{Operating Systems:}}
			\begin{itemize}
				\item{Linux (Gentoo, Arch, Slackware, Ubuntu, Fedora, Debian)}
				\item{Mac OS X}
				\item{Windows (XP, Vista, 7)}
			\end{itemize}
		\item{\textbf{Programming Languages:}}
			\begin{itemize}
				\item{Proficient in: }{C, C++, Assembly (x86, MIPS), Python, Java, Makefile, Git}
				\item{Familiar with: }{LaTex, Bash, GNU Autotools, SVN}
			\end{itemize}
	\end{description}
}
%%%%%%%%%%%%%%%%%%%%%%
...
{\footnotesize
	\begin{itemize}
			\item
			\ressubheading{Exablox}{\href{http://www.exablox.com/}{exablox.com}}{File System Performance Intern}{June 2013 - Present} 
			{ \footnotesize
				\begin{itemize}
					\item{Tuned and optimized our object-based file system}
					\item{Developed tools and internal file system checks for performance diagnostics}
...
\resheading{Online Presence}
{
	\begin{tabularx}{2in}{XX}
		...
		Blog: & \href{http://www.slackwill.com/}{slackwill.com} \\
